...
export const Nine = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_3627_15151)">
        <rect
          className="rect"
          fill="#E6E6E6"
          height="27.6377"
          ...
          width="208.763"
        />
        <g className="g" filter="url(#filter0_f_3627_15151)">
          <path
            className="path"
            clipRule="evenodd"
        ...
        <g className="g" filter="url(#filter1_f_3627_15151)">
          <path
            className="path"
            clipRule="evenodd"
        ...
        <g className="g" filter="url(#filter2_f_3627_15151)">
          <path
            className="path"
            clipRule="evenodd"
        ...
        <g className="g" filter="url(#filter3_f_3627_15151)">
          <path
            className="path"
            clipRule="evenodd"
        ...
        <g className="g" filter="url(#filter4_f_3627_15151)">
          <path
            className="path"
            clipRule="evenodd"
      ...
      <defs className="defs">
        ...
        <clipPath className="clip-path" id="clip0_3627_15151">
          <rect
            className="rect"
            fill="white"
            height="27.6377"
