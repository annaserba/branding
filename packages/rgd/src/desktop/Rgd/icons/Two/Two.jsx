...
export const Two = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path className="path" d="M155.793 47.9712V29.0713" />
      <path className="path" d="M108.292 29.071L120.371 16.9922" />
      <path className="path" d="M95.99 16.7685L101.863 10.8924V0.80957" />
      <path
        className="path"
      ...
      />
      <path className="path" d="M37.5054 50.2559V67.8869" />
      <path
        className="path"
      ...
      />
      <path className="path" d="M98.8651 19.6455L85.5527 32.9579" />
      <path
        className="path"
        d="M108.292 29.0711L95.9898 16.7686H82.6421"
      />
      <path className="path" d="M140.99 14.2686L155.792 29.0705" />
      <path className="path" d="M17.6756 30.4223V17.6516L16.6069 16.583" />
      <path
        className="path"
