...
const StyledEighteen = styled.svg`
  .path {
    stroke: #bebebe;
...
export const Eighteen = ({ className }) => {
  return (
    <StyledEighteen
    ...
    >
      ...
      />
      <path className="path" d="M39.2069 14.1409V9.81336L47.4675 1.5498" />
      <path
        className="path"
        d="M51.7245 4.9707L37.9618 18.7364V26.5672L24.6965 39.8324"
      />
      <path className="path" d="M9.76294 49.4323V31.9014" />
      <path className="path" d="M3.9187 49.4321V39.832" />
      <path
        className="path"
